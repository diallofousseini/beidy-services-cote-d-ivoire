    ...
    <section id="realisations" className="py-10 sm:py-12 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between mb-10 gap-6">
          ...
          {/* Filter Tabs aligned on same row in right column */}
          <div className="flex flex-wrap items-center gap-1.5 sm:gap-2 bg-[#F8F9FA] p-1.5 rounded-xl border border-gray-200 shrink-0">
            <button
